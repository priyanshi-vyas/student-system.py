...
def connect_database():
    def connect():
        global mycursor,con
        try:
            con=pymysql.connect(host='localhost',user='root',password='PHW#84#jeor')
            mycursor=con.cursor()
        except:
...
style.configure('Treeview', rowheight=40,font=('arial', 12, 'bold'), fieldbackground='pink1', background='pink1',)
style.configure('Treeview.Heading',font=('arial', 14, 'bold'),foreground='maroon')
